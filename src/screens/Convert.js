    ...
    <ScreenContainer headerTitle={'Convert'}>
      ...
      <View style={styles.convertBtn}>
        <Button
          ...
          disabled={
            ndauAmount.length === 0 ||
            totalBalance === 0 ||
            getRemainNdauBalance(ndauAmount) === 0 ||
            npayAddress === ''
          }
        />
      </View>
      ...
      <CustomModal bridge={modalRef2}>
        <View style={styles.modal}>
          ...
          <Spacer height={20} />
          <CustomText body>
            NDAU is converted to NPAY on a 1:1 basis.  All NDAU converted from this NDAU address will be sent to your
            NPAY address that is listed under the “Tokens” screen in this wallet app.
          </CustomText>
        </View>
        <View>
